// Question Bank 1 — CIS-DF Practice Exam (83 Questions)
// Extracted from "extracted Qs 1.docx"

export const bankMeta = {
  id: 'bank1',
  title: 'CIS-DF Practice Exam',
  description: 'Comprehensive CIS Discovery Fundamentals practice exam covering CMDB, CSDM, Discovery, Service Graph Connectors, and more.',
  totalQuestions: 83,
  passingScore: 70,
  timeLimitMinutes: 90,
};
...
export const questions = [
  ...
  },
  {
    ...
    type: 'multi',
    instruction: 'Choose 2 options.',
    text: 'A CMDB Administrator wants to leverage the CMDB Data Foundations Dashboard. What are benefits of using this application?',
    options: [
  ...
  },
  {
    ...
    text: 'Match each de-duplication feature to its corresponding outcome.',
    sources: [
  ...
  },
  {
    ...
    type: 'multi',
    instruction: 'Choose 2 options.',
    text: 'A CMDB Administrator is using the Duplicate CI Remediator to address a de-duplication task. On the first tab of the wizard, the Main CI is selected. Which attributes are used to identify the Main CI?',
    options: [
      'A. Oldest Created',
      'B. Newest Created',
  ...
  },
  {
    id: 64,
    type: 'drag-match',
    instruction: 'Drag and drop the CSDM domains to the respective benefits.',
    text: 'Match each CSDM domain to its corresponding benefit.',
    sources: [
      'Design and Planning',
      'Service Delivery',
      'Service Consumption',
    ...
    correctAnswer: {
      'Design and Planning': 'Understand CIs related to business application and related capabilities, identify redundancies, monitor costs and make better investments around roadmap',
      ...
      'Service Consumption': 'Understand business services and ownership, cost, scope of what is provided to the business/consumer and request access to the business services',
  ...
  },
  {
    id: 65,
    type: 'drag-match',
    instruction: 'Drag the domain to the roles that make up the governance team.',
    text: 'Match each CSDM domain to its governance team roles.',
    sources: [
      'Foundation Domain',
      'Portfolio Domain',
      'Technical Domain',
  ...
  },
  {
    id: 66,
    type: 'drag-match',
    instruction: 'Drag and drop the design architecture to its management tool.',
    text: 'Match each design architecture to its management tool.',
    sources: [
  ...
  },
  {
    id: 67,
    type: 'drag-match',
    instruction: 'Drag and drop the product to its description.',
    ...
    correctAnswer: {
      ...
      'Service Graph Connectors': 'Facilitates integration between ServiceNow and external systems to import and synchronize data',
  ...
  },
  {
    id: 68,
    type: 'drag-match',
    instruction: 'Drag and drop the system property to the functionality.',
    text: 'Match each system property to its functionality.',
    sources: [
  ...
  },
  {
    id: 69,
    type: 'drag-match',
    instruction: 'Drag the sub-metrics to the KPI.',
    text: 'Match each sub-metric to its KPI category.',
    sources: [
      'Required',
      'Suggested',
      'Audit',
  ...
  },
  {
    ...
    type: 'drag-match',
    instruction: 'Drag and drop each feature with the corresponding outcome.',
    text: 'Match each de-duplication feature to its outcome. (Note: same as Q15)',
    sources: [
      'De-Duplication Tasks',
      'CMDB Health Dashboard Correctness Scorecard',
      'De-Duplication Templates',
  ...
  },
  {
    ...
    text: 'A CMDB Administrator needs to prevent duplicate CI creation from import sets that load data into the CMDB from vendor shipment files containing CI information. How can the Administrator do this?',
    options: [
      'A. Set the coalesce on two mappings within the transform map',
      'B. Create comparison rules in the IRE',
      'C. Use the CMDBTransformUtil API in the transform script',
      'D. Set the system property to utilize the IRE within transform maps',
    ],
    correctAnswer: 'D',
  },
  {
    ...
    text: 'A CMDB Administrator wants to use the CMDB and CSDM Data Foundations Dashboard. Where can the Administrator obtain the dashboard?',
    options: [
      'A. It is a paid application on the ServiceNow Store.',
      'B. It is a free application on the ServiceNow Store.',
  ...
  },
  {
    id: 82,
    type: 'drag-match',
    instruction: 'Drag and drop (Drag and Drop matching).',
    text: 'ServiceNow provides a suite of CMDB management tools designed to effectively ingest, manage, and maintain CIs and relationships. Drag and drop the design architecture to its management tool. Some options may not apply.',
    sources: [
      'Organization-built solution using transform maps',
      'Automated agent-based solution running patterns',
      'Automated agentless solution running patterns',
